...
public class Pagination implements Serializable{
    ...
    public static void main(String[] args) {
    	Pagination page = new Pagination(1,100000,999999);
    	for(int i=1;i<=page.pageCount;i++){
    		Pagination page_ = new Pagination(i,100000,999999);
    		System.out.println(page_.getOffset()+","+(page_.getOffset()+100000));
    	}
	}
}